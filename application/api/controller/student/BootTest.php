...
class BootTest extends Api
{
    ...
    public function getorder(){
        ...
        // $params['stu_id'] = 'CSN20231109165605497816';
        ...
        $pay['client_sn'] = [];
        if($pay_status){
            $where_pay_subject2['cooperation_id'] = $space_machine['cooperation_id'];
            $where_pay_subject2['type'] = 'type2';
            $pay_subject2 = $this->device->where($where_pay_subject2)->find();
            $where_pay_subject3['cooperation_id'] = $space_machine['cooperation_id'];
