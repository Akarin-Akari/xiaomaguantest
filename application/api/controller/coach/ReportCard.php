...
class ReportCard extends Api
{
    ...
    public function report_card()
    {
        ...
        $params['coach_id'] = 'CTN20210630145213646894';
        $params['page'] = '1';
        ...
        $pagenum = 10;
        $numl = $pagenum*($page-1);
        $reportcard = $this->reportcard->with(['machinecar','coach','admin','space'])->where(['coach_id'=>$params['coach_id']])->limit($numl,$pagenum)->select();
        $data = [];
