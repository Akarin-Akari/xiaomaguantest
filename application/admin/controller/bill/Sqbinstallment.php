 ...
 * @icon fa fa-circle-o
 */
class Sqbinstallment extends Backend
{

    /**
     * Sqbinstallment模型对象
     * @var \app\admin\model\Sqbinstallment
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\Sqbinstallment;
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            foreach ($list as $row) {
                $row->visible(['id','stu_id','sn','client_sn','total_amount','cooperation_id','createtime']);
                $row->visible(['admin']);
