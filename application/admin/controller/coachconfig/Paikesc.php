...
class Paikesc extends Backend
{
    ...
    public function _initialize()
    {
        ...
        $this->order = new \app\admin\model\Ordersc;
    ...
    public function add_paike()
    {
        ...
        $time_list = Db::name('coach_sc_config_time_people')->where(['coach_id'=>$coach_id])->select();
    ...
    public function operation()
    {
        ...
        $inner = $_POST['inner'];
        $day = $_POST['day'];
        $config_time = Db::name('coach_sc_config_time_people')->where(['coach_id'=>$id])->select();
    ...
    function coach_order($coach,$request_datetime){
        ...
        foreach($coach['timelist'] as $k=>$v){
            ...
            $timelist[$k]['cartype1'] = Db::name('order_sc')->where($where)->count();
            $where['car_type'] = 'cartype2';
            $timelist[$k]['cartype2'] = Db::name('order_sc')->where($where)->count();
