 ...
 * @icon fa fa-circle-o
 */
class Keerleijiai extends Backend
{
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\Keerleijiai;
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            $where1['keerleijiai.keer_leiji'] = ['<>', 'NULL'];
            $this->cooperation_list = $_SESSION['think']['admin']['cooperation_list'];
            $where_cooperation['keerleijiai.cooperation_id'] = ['in', $this->cooperation_list];
