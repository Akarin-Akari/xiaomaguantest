 ...
 * @icon fa fa-circle-o
 */
class Kesanhegeai extends Backend
{
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\Kesanhegeai;
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            $where_cooperation['kesanhegeai.cooperation_id'] = ['in',$this->cooperation_list];
            $where1['kesanhegeai.kesan_hege'] = ['<>','NULL'];
            $list = $this->model
            ...
            foreach ($list as $row) {
				...
				$row->getRelation('warnexamai')->visible(['kesan_hege']);
            }
