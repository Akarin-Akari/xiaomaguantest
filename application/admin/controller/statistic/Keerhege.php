 ...
 * @icon fa fa-circle-o
 */
class Keerhege extends Backend
{
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\Keerhege;
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            $where_cooperation['keerhege.cooperation_id'] = ['in',$this->cooperation_list];
            // var_dump($where);exit;
            $where1['keerhege.keer_hege'] = ['<>','NULL'];
            $list = $this->model
