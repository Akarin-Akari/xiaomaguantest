...
class Trainstatisticai extends Model
{
    ...
    // 表名
    protected $name = 'train_statistic_ai';
    ...
    public function warnexam()
    {
        return $this->belongsTo('warnexam', 'cooperation_id', 'cooperation_id', [], 'LEFT')->setEagerlyType(0);
    }
}
