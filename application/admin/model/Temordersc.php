...
class Temordersc extends Model
{
    ...
    // 表名
    protected $name = 'temporary_order_sc';
    ...
    {
        return $this->belongsTo('app\admin\model\intent\Student', 'stu_id', 'stu_id', [], 'LEFT')->setEagerlyType(0);
    }
    ...
    public function car()
    {
        return $this->belongsTo('Car', 'machine_id', 'id', [], 'LEFT')->setEagerlyType(0);
    }
    
    public function machineai()
    {
        return $this->belongsTo('app\admin\model\machine\Ai', 'machine_ai_id', 'id', [], 'LEFT')->setEagerlyType(0);
    }
}
