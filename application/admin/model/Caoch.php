...
class Caoch extends Model
{
    ...
    public function getTeachTypeList()
    {
        return ['ai_teach' => __('Teach_type ai_teach'), 'car_teach' => __('Teach_type car_teach')];
    }
    ...
    public function getTeachTypeTextAttr($value, $data)
    {
        $value = $value ? $value : (isset($data['teach_type']) ? $data['teach_type'] : '');
        $list = $this->getTeachTypeList();
        return isset($list[$value]) ? $list[$value] : '';
    }
