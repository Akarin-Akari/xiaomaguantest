...
class Certificate extends Model
{
    ...
    public function getPzStatusList()
    {
        return ['0' => __('Pz_status 0'), '1' => __('Pz_status 1')];
    }
    ...
    public function getPzStatusTextAttr($value, $data)
    {
        $value = $value ? $value : (isset($data['pz_status']) ? $data['pz_status'] : '');
        $list = $this->getPzStatusList();
        return isset($list[$value]) ? $list[$value] : '';
    }
