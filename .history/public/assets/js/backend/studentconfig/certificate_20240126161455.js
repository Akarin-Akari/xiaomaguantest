                    ...
                    [
                        ...
                        {field: 'name', title: __('Name'), operate: 'LIKE',
                            formatter: function (value, row, index) {
                                if(!row) return '-';
                                value='<a href="javascript:void(0);" data-url="studentconfig/student/edit/ids/' + row.id
                                    +'" data-area="[&quot;50%&quot;,&quot;100%&quot;]" class="btn-dialog" data-title="'+ row.name+'">'+row.name+'</a>';
                                return value;
                            },
                        },
                        {field: 'phone', title: __('Phone')},
                        {field: 'swlsh', title: __('Swlsh')},
