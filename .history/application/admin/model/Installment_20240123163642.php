...
class Installment extends Model
{
    ...
    public function fundsclass()
    {
        return $this->belongsTo('FundsClass', 'fund_class_id', 'id', [], 'LEFT')->setEagerlyType(0);
    }
    ...
    {
        return $this->belongsTo('PaymentSource', 'payment_source', 'id', [], 'LEFT')->setEagerlyType(0);
    }
}
