    ...
    var Controller = {
        ...
        table: {
            first: function () {
                ...
                //     Fast.api.open('coachconfig/paike/add_paike?data='+data,__('Generate URL'),{
                //         callback:function(value){
