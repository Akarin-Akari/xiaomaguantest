define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'coachconfig/coach/index' + location.search,
                    add_url: 'coachconfig/coach/add',
                    edit_url: 'coachconfig/coach/edit',
                    del_url: 'coachconfig/coach/del',
                    multi_url: 'coachconfig/coach/multi',
                    import_url: 'coachconfig/coach/import',
                    table: 'coach',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'teach_type', title: __('Teach_type'), searchList: {"ai_teach":__('Teach_type ai_teach'),"car_teach":__('Teach_type car_teach')}, formatter: Table.api.formatter.normal},
