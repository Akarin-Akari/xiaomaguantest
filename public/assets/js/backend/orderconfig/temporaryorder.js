...
define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'orderconfig/temporaryorder/index' + location.search,
                    add_url: 'orderconfig/temporaryorder/add',
                    edit_url: 'orderconfig/temporaryorder/edit',
                    del_url: 'orderconfig/temporaryorder/del',
                    multi_url: 'orderconfig/temporaryorder/multi',
                    import_url: 'orderconfig/temporaryorder/import',
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'intentstudent.stu_id', title: __('Intentstudent.stu_id')},
                        {field: 'intentstudent.name', title: __('Intentstudent.name')},
                        {field: 'intentstudent.phone', title: __('Intentstudent.phone'),operate:'LIKE'},
                        // {field: 'intentstudent.vx_name', title: __('Intentstudent.vx_name')},
                        ...
                        {field: 'should_endtime', title: __('Should_endtime'), operate:'RANGE', addclass:'datetimerange', autocomplete:false, formatter: Table.api.formatter.datetime},
