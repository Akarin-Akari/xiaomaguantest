define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'bill/sqb/index' + location.search,
                    add_url: 'bill/sqb/add',
                    edit_url: 'bill/sqb/edit',
                    del_url: 'bill/sqb/del',
                    multi_url: 'bill/sqb/multi',
                    import_url: 'bill/sqb/import',
                    table: 'sqb',
                }
            });
