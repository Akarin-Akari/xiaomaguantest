define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'spaceconfig/machineai/index' + location.search,
                    // add_url: 'spaceconfig/machineai/add',
                    // edit_url: 'spaceconfig/machineai/edit',
                    // del_url: 'spaceconfig/machineai/del',
                    // multi_url: 'spaceconfig/machineai/multi',
                    // import_url: 'spaceconfig/machineai/import',
                    table: 'machine_ai',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'LocalVersions', title: __('LocalVersions'), operate: 'LIKE'},
                        {field: 'MainVersions', title: __('Mainversions'), operate: 'LIKE'},
                        {field: 'UnitySceneName', title: __('Unityscenename'), operate: 'LIKE'},
                        {field: 'ChineseSceneName', title: __('Chinesescenename'), operate: 'LIKE'},
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'spaceconfig/machineai/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
                            ...
                            buttons: [
                                {
                                    ...
                                    url: 'spaceconfig/machineai/restore',
                                    refresh: true
                                },
                                {
                                    name: 'Destroy',
                                    ...
                                    icon: 'fa fa-times',
                                    url: 'spaceconfig/machineai/destroy',
                                    refresh: true
                                }
                            ],
