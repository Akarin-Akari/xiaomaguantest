define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'spaceconfig/pickupcar/index' + location.search,
                    add_url: 'spaceconfig/pickupcar/add',
                    edit_url: 'spaceconfig/pickupcar/edit',
                    del_url: 'spaceconfig/pickupcar/del',
                    multi_url: 'spaceconfig/pickupcar/multi',
                    import_url: 'spaceconfig/pickupcar/import',
                    table: 'pickup_car',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'spaceconfig/pickupcar/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
                            ...
                            buttons: [
                                {
                                    ...
                                    url: 'spaceconfig/pickupcar/restore',
                                    refresh: true
                                },
                                {
                                    name: 'Destroy',
                                    ...
                                    icon: 'fa fa-times',
                                    url: 'spaceconfig/pickupcar/destroy',
                                    refresh: true
                                }
                            ],
